...
function aletheme_get_options() {
    ...
    $options[] = array( "name" => "Insert The Slider",
    ...
    $options[] = array( "name" => "Select the Headers Font from Google Library",
                        "desc" => "The default Font is - Playfair Display SD",
                        "id" => "ale_mainfont",
                        "std" => "Playfair+Display+SD",
                        "type" => "select",
                        "options" => $headerfont);
	...
	$options[] = array( "name" => "Phone Number",
                        "desc" => "Insert you phone number",
                        "id" => "ale_footer_phone",
                        "std" => "",
                        "type" => "text");

    $options[] = array( "name" => "Address",
                        "desc" => "Insert you address",
                        "id" => "ale_footer_address",
                        "std" => "",
                        "type" => "text");

    $options[] = array( "name" => "Email",
                        "desc" => "Insert you email",
                        "id" => "ale_footer_email",
                        "std" => "",
                        "type" => "text");
    ...
    $options[] = array( "name" => "Map Style",
                        "desc" => "Insert the map style from Snazzy Maps Servise",
                        "id" => "ale_mapstyle",
                        "std" => "",
                        "type" => "text");
	return $options;
