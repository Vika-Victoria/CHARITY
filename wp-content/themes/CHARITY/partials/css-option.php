...
$ale_thirtfont = ale_get_option('thirtfont');
...
<?php
    ...
    if(ale_get_option('thirtfontex')){ $mainfontex = ":".ale_get_option('thirtfontex'); } else {$thirtfontex = "";}
    if(ale_get_option('headerfont')){ echo "<link href='http://fonts.googleapis.com/css?family=".ale_get_option('headerfont').$headerfontex."|".ale_get_option('mainfont').$mainfontex."|".ale_get_option('thirtfontex')."' rel='stylesheet' type='text/css'>"; }
?>
<style type='text/css'>
    body {
        <?php
   ...
   .font_two, .ale_about_page .our_people .top_titles .center_info h3.people_title {
    ...
    .font_three {
        <?php if($ale_thirdfont){ $thirdfontname =  str_replace ('+',' ',$ale_mainfont); echo "font-family:".$thirdfontname.";"; } ?>
    }
