        ...
        <div class="about_container">
            ...
            <section class="info_box" data-type="background" <?php if (ale_get_meta('info_bg')){echo 'style="background-image:url('. ale_get_meta('info_bg') .')"';} ?>>
                <div class="center_block">
                    <h3 class="info_tile"><?php echo ale_get_meta('info_title') ?></h3>
                ...
                <section class="services_items">
                    <div class="wrapper">
                        <div class="services_list">
                            <div class="sery_item">
                                <?php if (ale_get_meta('info_icon1')){?>
                                    <div class="icon_box">
                                        <img src="<?php echo ale_get_meta('info_icon1')?>" alt="">
                                    </div>
                                <?php } ?>
                            ...
                            <div class="sery_item">
                                <?php if (ale_get_meta('info_icon2')){?>
                                    <div class="icon_box">
                                        <img src="<?php echo ale_get_meta('info_icon2')?>" alt="">
                                    </div>
                                <?php } ?>
                            ...
                            <div class="sery_item">
                                <?php if (ale_get_meta('info_icon3')){?>
                                    <div class="icon_box">
                                        <img src="<?php echo ale_get_meta('info_icon3')?>" alt="">
                                    </div>
                                <?php } ?>
                            ...
                            <div class="sery_item">
                                <?php if (ale_get_meta('info_icon4')){?>
                                    <div class="icon_box">
                                        <img src="<?php echo ale_get_meta('info_icon4')?>" alt="">
                                    </div>
                                <?php } ?>
                        ...
                        <div class="top_titles">
                            ...
                            <div class="center_info">
                                <?php if (ale_get_meta('people_title')){?>
                                    <h3 class="people_title"><?php echo ale_get_meta('people_title')?></h3>
                                <?php } ?>
                                <?php if (ale_get_meta('people_text')){?>
                                    <span class="people_desc"><?php echo ale_get_meta('people_text')?></span>
                                <?php } ?>
                            </div>
                                ...
                                <div class="item_people">
                                    <div class="mask_hover">
                                        ...
                                        <div class="people_info">
                                            ...
                                            <?php if (ale_get_meta('people_post')){?><span class="post"><?php  echo ale_get_meta('people_post'); ?></span><?php } ?>
                                        </div>
                                    </div>
                                </div>
